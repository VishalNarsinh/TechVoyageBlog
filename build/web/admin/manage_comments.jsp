            ...
            <div class="card-body pe-0">
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <div class="text-right">
                        ...
                        <button type="button" onclick="deleteComment(<%= comment.getCom_id()%>)" class="btn"><i class="text-danger fa-solid fa-trash"></i></button>
                        <script>
                            function deleteComment(com_id) {
                                ...
                                $.ajax({
                                    ...
                                    success: function (data, textStatus, jqXHR) {
                                        console.log(data);
                                        if (data.trim() == 'true') {
                                            loadCommentNo(<%= comment.getPid()%>);
                                            manageComments(<%= comment.getPid()%>);
                                        }
                                    },
