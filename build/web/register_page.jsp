            ...
            <div class="container" style="margin-top:0px;">
                <div class="col-sm-6 offset-sm-3">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form autocomplete="off" novalidate="" action="RegisterServlet" method="post" id="reg-form">
                                ...
                                <div class="mb-1 text-center" style=""> 
                                ...
                                <div class="mb-1" style="display: none;" id="otp-div">
                                ...
                                <script>
                                    $(document).ready(function () {
                                        ...
                                        $("#otp-btn").on('click', function () {
                                            ...
                                            $("#otp-div").hide();
                                            $.ajax({
                                                url: 'SendEmailForUserVerification',
                                                method: 'POST',
                                ...
                                <div class="mb-1">
                                    ...
                                    <br>
                                    <small class="ms-1" id="gender-msg"></small>
                                </div>

                                <div class="form-floating mb-3">
                                    <textarea name="about" class="form-control" placeholder="" id="floatingTextarea2" style="height: 100px"></textarea>
                                    <label for="floatingTextarea2">Tell something about yourself</label>
                                </div>

                                <div class="mb-3 form-check">
                                    <input type="checkbox" name="check" class="form-check-input" id="exampleCheck1">
                                    <label class="form-check-label" for="exampleCheck1">Agree to our Terms & Conditions</label>
                                </div>
