                            ...
                            <div class="card-body">
                                <form autocomplete="off" action="LoginServlet" method="post">
                                    <div class="mb-3">
                                        ...
                                        <input name="email" required type="email" class="form-control" id="user_email" aria-describedby="emailHelp" placeholder="peterparker@gmail.com">
                                    ...
                                    <div class="text-center">
                                        ...
                                        <a href="forgot_password.jsp" class="btn btn-custom">Forgot Password?</a>
                                    </div>
                                </form>
                            </div>
                        </div>
